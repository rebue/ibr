...
public class IbrInviteRelationMo implements Serializable {

    /**
     *    邀请关系ID
     *
     *    数据库字段: IBR_INVITE_RELATION.ID
     *
     ...
     *    邀请人ID，也就是邀请人的用户ID
     *
     *    数据库字段: IBR_INVITE_RELATION.INVITER_ID
     *
     *    @mbg.generated 自动生成，如需修改，请删除本行
     */
     ...
     *    被邀请人ID，也就是被邀请人的用户ID
     *
     *    数据库字段: IBR_INVITE_RELATION.INVITEE_ID
     *
     *    @mbg.generated 自动生成，如需修改，请删除本行
     */
     ...
     *    邀请时间戳
     *
     *    数据库字段: IBR_INVITE_RELATION.INVITE_TIMESTAMP
     *
     *    @mbg.generated 自动生成，如需修改，请删除本行
     */
    ...
    public boolean equals(Object that) {
        ...
        IbrInviteRelationMo other = (IbrInviteRelationMo) that;
