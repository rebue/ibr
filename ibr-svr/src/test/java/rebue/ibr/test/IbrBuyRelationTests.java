...
public class IbrBuyRelationTests {
    ...
    public void testCrud() throws IOException, ReflectiveOperationException {
        ...
        final String getByIdResult = OkhttpUtils.get(hostUrl + "/ibr/BuyRelation/getById?id=" + mo.getId());
        System.out.println("获取单个购买关系表的返回值为：" + getByIdResult);
        System.out.println("修改购买关系表的参数为：" + mo);
        final String modifyResult = OkhttpUtils.putByJsonParams(hostUrl + "/ibr/BuyRelation", mo);
        ...
        System.out.println("删除购买关系表的参数为：" + mo.getId());
        final String deleteResult = OkhttpUtils.delete(hostUrl + "/ibr/BuyRelation?id=" + mo.getId());
        System.out.println("删除购买关系表的返回值为：" + deleteResult);
